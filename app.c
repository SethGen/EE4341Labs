...
//    int8_t dir_table[] ={-4,-4,-4, 0, 4, 4, 4, 0};
    int8_t x_table[] ={5,0,-5,0};
    int8_t y_table[] ={0,-5,0,5};
        ...
        case APP_STATE_MOUSE_EMULATE:
            ...
            if(appData.emulateMouse)
            {
                ...
                if(movement_length > 50)
                {
                    ...
                    appData.xCoordinate =(int8_t)x_table[vector % 4] ;
                    appData.yCoordinate =(int8_t)y_table[vector % 4];
                    vector ++;
                    movement_length = 0;
                }
            }
